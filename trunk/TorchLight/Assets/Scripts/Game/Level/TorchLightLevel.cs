...
public class FStrata
{
    ...
    {
        RuleSet = InRuleSet + ".txt";
        LoadRuleSet();
    }

    void LoadRuleSet()
    {
        StreamReader Reader = TorchLightTools.GetStreamReader(RuleSet);
...
public class TorchLightLevel {
    ...
    static public Dictionary<string, PirceItem> GetAllPieceItems()
    {
        ...
        {
            StreamReader Reader = TorchLightTools.GetStreamReader(LayoutSetItemPath);
    ...
    static public List<LevelItem> ParseLevelLayout(string LayoutPath)
    {
        ...
        {
            StreamReader Reader = TorchLightTools.GetStreamReader(LayoutPath + ".txt");
            while (!Reader.EndOfStream)
            {
                string Line = Reader.ReadLine().Trim();
